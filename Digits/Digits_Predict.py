...
pickle_file = 'D:/Deep Learning/My Dataset/mnist.pkl'
...
def main(): 
    ...
    global x_image
    global optimizer 
    global layer_conv1, weights_conv1
    global layer_conv2, weights_conv2
    global layer_flat, num_features
    global layer_fc1, layer_fc2
    global cross_entropy
    global cost
    global correct_prediction, accuracy
    global saver, save_dir, save_path
